export const holidayDestinations = [
  { slug: 'thailand', name: 'Thailand', region: 'Southeast Asia', price: 55000, image: 'https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?w=1600&h=900&fit=crop&q=80' },
  { slug: 'bali', name: 'Bali', region: 'Indonesia', price: 60000, image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=1600&h=900&fit=crop&q=80' },
  { slug: 'andaman', name: 'Andaman', region: 'India', price: 35000, image: 'https://images.unsplash.com/photo-1573843981267-be1999ff37cd?w=1600&h=900&fit=crop&q=80' },
  { slug: 'kashmir', name: 'Kashmir', region: 'India', price: 30000, image: 'https://images.unsplash.com/photo-1595815771614-ade9d652a65d?w=1600&h=900&fit=crop&q=80' },
  { slug: 'ladakh', name: 'Ladakh', region: 'India', price: 40000, image: 'https://images.unsplash.com/photo-1590080875852-4a8e4e07d5f5?w=1600&h=900&fit=crop&q=80' },
  ...
  { slug: 'vietnam', name: 'Vietnam', region: 'Southeast Asia', price: 50000, image: 'https://images.unsplash.com/photo-1528127269322-539801943592?w=1600&h=900&fit=crop&q=80' },
  { slug: 'japan', name: 'Japan', region: 'East Asia', price: 1200000, image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=1600&h=900&fit=crop&q=80' },
  { slug: 'switzerland', name: 'Switzerland', region: 'Europe', price: 180000, image: 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?w=1600&h=900&fit=crop&q=80' },
  { slug: 'france', name: 'France', region: 'Europe', price: 160000, image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=1600&h=900&fit=crop&q=80' },
  { slug: 'australia', name: 'Australia', region: 'Oceania', price: 200000, image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600&h=900&fit=crop&q=80' },
  ...
  { slug: 'kenya', name: 'Kenya', region: 'Africa', price: 250000, image: 'https://images.unsplash.com/photo-1523805009345-7448845a9e53?w=1600&h=900&fit=crop&q=80' },
...
export const pilgrimageDestinations = [
  { slug: 'char-dham', name: 'Char Dham Yatra', region: 'Uttarakhand', price: 45000, image: 'https://images.unsplash.com/photo-1609766857384-89bfb69ac882?w=1600&h=900&fit=crop&q=80' },
  ...
  { slug: 'kedarnath-badrinath', name: 'Kedarnath–Badrinath', region: 'Uttarakhand', price: 35000, image: 'https://images.unsplash.com/photo-1609766857384-89bfb69ac882?w=1600&h=900&fit=crop&q=80' },
]
